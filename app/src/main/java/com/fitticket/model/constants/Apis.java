...
//public static  final String BASE_URL="http://fiticketsvc.cloudapp.net:8080/";// Production NotUsed
    ...
    //New upcoming confirmed activities for the day api
    public static final String GET_UPCOMING_ACTIVITIES_URL_FOR_TODAY = URL + "GetTodaysUpcomingActivities?customerId=";
    //Activities Apis
    ...
    //mark attendance
    public static final String TRACKING_ATTENDANCE_URL = URL +"AttendanceTracking";

    //ratings
    public static final String GET_UNRATED_ACTIVITIES = URL + "GetUnratedAttendedActivities_v2?customerId=";
    public static final String RATE_ACTIVITIES =URL+ "RateGym";


    //buypage
    public static final String GET_BUY_PAGE_MAIN_CATEGORY = URL + "GetBuyPageCategory";
    public static final String GET_BUY_PAGE_PRODUCT_BY_CATEGORY = URL + "GetBuyPageProductByCategory?categoryId=";
