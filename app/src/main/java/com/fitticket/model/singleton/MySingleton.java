...
import com.fitticket.viewmodel.utils.LruBitmapCache;
...
public class MySingleton {
    ...
    private ArrayList<BuyPageCategoryJsonResponse.BuyPageCategoryJson> buyPagecategoryList;
    ...
    private MySingleton(Context context) {
        ...
        buyPagecategoryList= new ArrayList<>();
    ...
    public ArrayList<BuyPageCategoryJsonResponse.BuyPageCategoryJson> getBuyPagecategoryList() {
        return buyPagecategoryList;
    }

    public void setBuyPagecategoryList(ArrayList<BuyPageCategoryJsonResponse.BuyPageCategoryJson> buyPagecategoryList) {
        this.buyPagecategoryList = buyPagecategoryList;
    }
