...
public class PreferencesManager {
    ...
    private static final String FIRST_RUN_FOR_COACH_MARKS = "FIRST_RUN_FOR_COACH_MARKS";
    private static final String PREFKEY_IS_FIRST_LOGIN = "PREFKEY_IS_FIRST_LOGIN";
    private static final String PREFKEY_SHOW_OVERLAY = "PREFKEY_SHOW_OVERLAY";
    private static final String PREFKEY_IS_PROFILE_UPDATE = "PREFKEY_IS_PROFILE_UPDATE";
    ...
    public void saveShowOverlay(boolean showOverlay) {
        sPref.edit().putBoolean(PREFKEY_SHOW_OVERLAY, showOverlay).commit();
    }
    public boolean showOverlay() {
        return (sPref.getBoolean(PREFKEY_SHOW_OVERLAY, false));
    }

    public void saveIsProfileUpdate(boolean isProfileUpdate) {
        sPref.edit().putBoolean(PREFKEY_IS_PROFILE_UPDATE, isProfileUpdate).commit();
    }
    public boolean isProfileUpdate() {
        return (sPref.getBoolean(PREFKEY_IS_PROFILE_UPDATE, false));
    }
    ...
    public boolean isFirstRunForCoachMarks() {
        return (sPref.getBoolean(FIRST_RUN_FOR_COACH_MARKS, true));
    }

    public void saveIsFirstRunForCoachMarks(boolean firstrun) {
        sPref.edit().putBoolean(FIRST_RUN_FOR_COACH_MARKS, firstrun).commit();
    }
