...
public class ActivityDetailJson implements Comparable<ActivityDetailJson> {
    ...
    public double getNonMemberCancelTime() {
        return nonMemberCancelTime;
    }

    public void setNonMemberCancelTime(double nonMemberCancelTime) {
        this.nonMemberCancelTime = nonMemberCancelTime;
    }
